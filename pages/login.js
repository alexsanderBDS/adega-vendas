...
const Login = () => {
  ...
  return (
    <div className="d-flex flex-column position-absolute h-100 w-100 justify-content-center align-items-center">
      <Header />
      <div className="shadow-lg p-3 mb-5 bg-body rounded d-flex flex-column gap-5 justify-content-center">
            ...
            <g id="profilePic">
              <g id="circle">
                <path
                  id="Vector"
                  opacity="0.5"
                  d="M349 698C541.747 698 698 541.747 698 349C698 156.253 541.747 0 349 0C156.253 0 0 156.253 0 349C0 541.747 156.253 698 349 698Z"
                  fill="url(#paint0_linear)"
                />
                <path
                  id="Vector_2"
                  d="M349.68 688.41C538.363 688.41 691.32 535.453 691.32 346.77C691.32 158.087 538.363 5.13 349.68 5.13C160.997 5.13 8.04001 158.087 8.04001 346.77C8.04001 535.453 160.997 688.41 349.68 688.41Z"
                  fill="#F5F5F5"
                />
              </g>
              <g id="person">
                <path
                  id="Vector_3"
                  d="M350 689.76C416.757 689.869 482.068 670.323 537.79 633.56C525.2 564.76 477.29 560.84 477.29 560.84H213.09C213.09 560.84 167.88 564.55 153.76 627.84C211.209 668.251 279.762 689.881 350 689.76V689.76Z"
                  fill="#6C63FF"
                />
                <path
                  id="Vector_4"
